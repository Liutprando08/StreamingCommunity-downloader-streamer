...
# Downloader
from StreamingCommunity.core.downloader import HLS_Downloader, MP4_Downloader
...
def download_episode(obj_episode, index_select, scrape_serie, video_source):
    ...
    if scrape_serie.is_series:
        mp4_path = os_manager.get_sanitize_path(
            os.path.join(site_constants.ANIME_FOLDER, scrape_serie.series_name)
        )
    else:
        mp4_path = os_manager.get_sanitize_path(
            os.path.join(site_constants.MOVIE_FOLDER, scrape_serie.series_name)
        )
