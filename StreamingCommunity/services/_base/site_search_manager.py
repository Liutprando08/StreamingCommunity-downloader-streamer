...
def get_select_title(table_show_manager, media_search_manager):
    ...
    color_index = 1
    for key in first_media_item.__dict__:
...
def base_process_search_result(
    select_title: Optional[Entries],
    download_film_func: Optional[Callable[[Entries], Any]] = None,
    download_series_func: Optional[
        Callable[[Entries, Optional[str], Optional[str], Optional[Any]], Any]
    ] = None,
    media_search_manager: Optional[EntriesManager] = None,
    table_show_manager: Optional[TVShowManager] = None,
    selections: Optional[Dict[str, str]] = None,
    scrape_serie: Optional[Any] = None,
) -> bool:
    """
    ...
    if str(select_title.type).lower() in ["tv", "serie", "ova", "ona", "show"]:
        ...
        result = download_series_func(
            select_title, season_selection, episode_selection, scrape_serie
        )
    ...
    # Handle films
        ...
        str(select_title.type).lower() == "film"
        or str(select_title.type).lower() == "movie"
    ):
